document.addEventListener('DOMContentLoaded', function() {
    ...
    const ROBOT_DATALARI = {
        "YKS": {
            ...
            "AYT TARİH": {
                "TEMEL DÜZEY": ["Çözüm yayınları", "Eis yayınları 9. sınıf"],
                "ORTA DÜZEY": ["Ramazan yetkin AYT (eşit)", "Ramazan yetkin AYT Soru Bankası", "3 4 5 Yayınları", "Yayın denizi", "Palme yayıncılık", "benim hocam"],
        ...
        "LGS": {
            ...
            "DİN KÜLTÜRÜ VE AHLAK BİLGİSİ": {
                ...
                "ORTA DÜZEY": ["Tonguç Yayınları Dinamo Soru Bankası", "Palme Yayıncılık Konu Anlatımlı", "Tudem Yayınları", "Nartest Yayınları", "Nitelik Yayınları", "Hız Yayınları Soru Bankası"],
                "İLERİ DÜZEY": ["Bilfen Yayınları –Pro Test", "Palme Yayınları – Plus Serisi"]
            }
        }
    };
    ...
    if (seviyeSecim) {
        seviyeSecim.addEventListener('change', function() {
            ...
            if (sinav && ders && seviye && ROBOT_DATALARI[sinav][ders][seviye]) {
                ...
                if (seviye === "TEMEL DÜZEY") { className = "kolay-kay
